...
<meta charset="UTF-8">
<script
	src="https://cdnjs.cloudflare.com/ajax/libs/fabric.js/4.5.1/fabric.min.js"></script>
...
<!-- Cropper.js CSS 파일 -->
<link href="https://cdn.jsdelivr.net/npm/cropperjs/dist/cropper.min.css"
	rel="stylesheet">
...
/* 편집 툴 css */
button#start-drawing-button, button#prev-button, button#next-button,
	button#reset-button, button#text-button, button#eraser-button, button#delete-button,
	button#send-to-back-button, button#bring-to-front-button, button#paint-btn,
	button#fill-btn, button#crop-button, button#save-jpg-button, div.group-5
	{
	border: 0px;
...
<body>
		...
		<div class="modal-dialog modal-fullscreen">
			<div class="modal-content">
				...
				<div id="guide-body" class="modal-body">
					<img id="guide_img" alt=""
						src="https://daydayday.s3.ap-northeast-2.amazonaws.com/EditPage/component/tuto.png">

					<div id="centered-button">
						<button class="centered-button">편집 시작하기</button>
						<div class="no_more">
							<label> <input type="checkbox" id="noShowAgain">
								더 이상 보지 않기
							</label>
						</div>
					</div>
		...
		<div class="container">
			<ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
				...
				<li class="nav-item rg">
					<div class="editable-div div" id="editable-div"
						contenteditable="true">제목을 입력하세요</div>
				</li>
			</ul>
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
					...
					<li class="nav-item" id="download-li">
						<button class="group-3" id="save-jpg-button">
							<div class="group-4">
								...
								<img class="img"
									src="${awsPath}/day/editor/download.png" />
							</div>
						</button>
					</li>
						...
						<div class="group-5" id="temp-box">
							...
							<div class="group-7">
								<div data-bs-toggle="modal" data-bs-target="#temp_Modal">
									<img class="img"
										src="${awsPath}/day/editor/temp.png" />
								</div>
							</div>
						</div>
					</li>
					...
					<li class="nav-item" id="save-li">
						<div class="group-wrapper" data-bs-toggle="modal"
		...
		<div id="image-edit-tools">
			...
			<div id="img-tools">
				<div id="img-edit-tool">
					<ul>
						<li id="photo-col-btn"><a href="#home" id="tab-1"
							onclick="changeColor('tab-1')">사진</a></li>
						<li id="bg-col-btn"><a href="#menu1" id="tab-2"
							onclick="changeColor('tab-2')">배경</a></li>
						<li id="sticker-col-btn"><a href="#menu2" id="tab-3"
							onclick="changeColor('tab-3')">스티커</a></li>
						<li id="ai-col-btn"><a href="#menu4" id="tab-4"
							onclick="changeColor('tab-4')">A.I</a></li>
					</ul>
				</div>

				<div id="photo-col" class="collapse">
					<div id="image-container">
						<div id="photo-upload-button" class="frame"
							style="min-width: 6.5em;">
							<img class="add-undefined-glyph"
								src="${awsPath}/day/editor/upload.png" alt="업로드">
							사진<br />가져오기 <input type="file" id="image-upload"
				...
				<div id="bg-col" class="collapse">
					<br>
					<div id="bg-container">
						<div id="bg-upload-button" class="frame" style="min-width: 6.5em;">
							<img class="add-undefined-glyph"
								src="${awsPath}/day/editor/upload.png" alt="업로드">
							사진<br />가져오기 <input type="file" id="background-upload"
								multiple="multiple" accept="image/*" style="display: none;">
						</div>
					</div>
				</div>
				...
				<div id="sticker-col" class="collapse">
					<br>
					<div id="sticker-container">
						<c:forEach items="${sticker}" var="stickers">
							<img class="sticker-img"
								src="data:image/png;base64,${stickers.sticker_url}"
								onclick="addStickerToCanvas('data:image/png;base64,${stickers.sticker_url}')" />
						</c:forEach>
					</div>
				</div>

				<div id="ai-col" class="collapse">
					<br>
					<div id="ai-container">
						<button type="button" class="frame" id="aimodal-button"
							data-bs-toggle="modal" data-bs-target="#imageEdit-modal">
							<img class="add-undefined-glyph"
								src="${awsPath}/day/editor/upload.png" alt="업로드">
							AI<br />사용하기
						</button>
			...
			<div id="edit-tool">
				...
				<button id="bring-to-front-button">
					<img src="${awsPath}/day/editor/stack-forward.png"
						alt="이미지 맨앞으로">
				</button>
				<button id="send-to-back-button">
					<img src="${awsPath}/day/editor/stack-backward.png"
						alt="이미지 맨뒤로">
				</button>
				<button id="start-drawing-button">
					<img src="${awsPath}/day/editor/pencil.png"
						alt="그리기 모드 시작">
				</button>
				<button id="paint-btn">
				...
				<div class="collapse" id="drawing-options1">
					<div class="drawing-tool">
						...
						<div class="line-width-div">
							두께<input type="range" id="line-width" min="1" max="10" value="2">
						</div>
					</div>
				</div>
				...
				<div class="collapse" id="drawing-options2">
					<div class="txt-tool">
						<div class="text-color-div">
							텍스트 색상<input type="color" id="text-color-picker" value="#000000">
						</div>
				...
				<div class="collapse" id="drawing-options3">
					<div class="eraser-tool">
						<div class="eraser-width-div">
							지우개 두께<input type="range" id="eraser-size-slider" min="1"
								max="50" value="10">
						</div>
					</div>
				</div>
		...
		<div class="modal-dialog modal-dialog-centered modal-xl" id="myModal">
			<div class="modal-content">
				...
				<div class="modal-header">
					<h4 id="modal-title" class="modal-title" style='text-align: center'>
					</h4>
				...
				<div class="modal-footer">
					<label  for="diaryname-selector">다이어리:</label> <select class="selector"
						id="diaryname-selector">
						<c:forEach var="item" items="${list}">
							<option value="${item.diary_name}">${item.diary_name}</option>
						</c:forEach>
					</select> <label for="category-selector">카테고리:</label> <select  class="selector" 
	...
	<!-- 임시저장  Modal -->
	<div class="modal fade" id="temp_Modal">
		<div class="modal-dialog modal-dialog-centered modal-dialog modal-l">
			<div class="modal-content">

				<!-- Modal Header -->
				<div class="modal-header">
					<h4 class="modal-title" id="modal-title">임시저장 보관함</h4>
					<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
				</div>
	...
	<div class="modal fade" id="cropModal" tabindex="-1"
		...
		<div class="modal-dialog" id="crop-modal">
			<div class="modal-content">
				<div class="modal-body" id="crop-body"
...
function resetColors() {
    var categories = ['tab-1', 'tab-2', 'tab-3', 'tab-4', 'tab-ai-1', 'tab-ai-2', 'tab-ai-3', 'tab-ai-4'];
  ...
  document.querySelectorAll('button').forEach(function(button) {
	...
	// 이벤트 리스너를 추가하여 윈도우 크기가 변경될 때마다 resizeCanvas 함수를 호출합니다.
	window.addEventListener('resize', resizeCanvas);

	// 처음에 페이지를 로드할 때 한 번 캔버스를 리사이즈하는 것을 잊지 마세요.
	resizeCanvas();
 ...
 opt.e.stopPropagation();
	...
	<script>
         ...
         editableDiv.addEventListener('blur', function() {
           if (this.textContent.trim() === '') {
             ...
             this.style.borderColor = 'red'; // 플레이스홀더 색상으로 다시 변경
           }else {
          ...
          $('#myModal').on('show.bs.modal', function (e) {
             ...
             // 캔버스에서 선택된 객체 해제
             canvas.discardActiveObject();
             canvas.requestRenderAll(); // 캔버스 상태 업데이트
	...
	document.getElementById('upload-button').addEventListener('click', function() {
	       ...
	       canvas.toBlob(function(blob) {
	           ...
	           formData.append('file', blob, 'blog.png'); // 'file'은 서버 측에서 기대하는 필드 이름입니다
    ...
    $.ajax({
        ...
        success: function(temp) {
            ...
            temp.forEach(function(temp, index) {
                ...
                label.for = 'temp_' + temp.temp_idx;
                radioButton.id = 'temp_' + temp.temp_idx;
                radioButton.type = 'radio';
                radioButton.name = 'temp'; // 같은 name으로 그룹화하여 한 번에 하나만 선택 가능하게 함
                radioButton.value = temp.temp_idx; // 라디오 버튼 값으로 스티커 ID 설정
                
                radioButton.onclick = function() {
                    editableDiv.textContent = temp.temp_title; // div의 내용을 선택된 제목으로 변경
                };
                ...
                label.appendChild(document.createTextNode(temp.temp_title));
...
$(".Ai-menu__a").click(function(){
	...
	<script src="${cpath}/resources/js/aiFunction/aiModal.js"></script>
